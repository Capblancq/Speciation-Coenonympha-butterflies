...
def admix(params, ns, pts):
    ## parse params
    N1,N2,N3,T2,T1,m13,m31,f = params
...
while i < 2:
	...
	params_admix = np.array([N1,N2,N3,T2,T1,m13,m31,f])
	...
	os.mkdir("./RESULTS_HS_geneflow_arcania/" + outputname)
	output_file = open(("./RESULTS_HS_geneflow_arcania/" + outputname + "/" + outputname + ".txt"), "w")
